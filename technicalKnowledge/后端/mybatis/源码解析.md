...
CollectionWrapper 实现了 ObjectWrapper 接口，其中封装了 Collection<Object>类型的对象，但它大部分实现方法都会抛出 UnsupportedOperationException 异常。Map Wrapper 是 BaseWrapper 的另一个实现类，其中封装的是 Map<String, Object>类型对象，实现与BeanWrapper类似。
